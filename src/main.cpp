...
Replacement_Policy REPPOLICY[] = {Replacement_Policy::Direct,Replacement_Policy::Random,Replacement_Policy::FIFO,Replacement_Policy::LIFO,Replacement_Policy::LRU};
string REPPOLICY_strings[] = {"Direct", "Random", "FIFO", "LIFO", "LRU"};
int REPPOLICY_size = 5;
